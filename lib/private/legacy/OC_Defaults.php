...
class OC_Defaults {
	...
	public function __construct() {
		...
		$this->defaultEntity = 'UniSheets'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'UniSheets'; /* short name, used when referring to the software */
		$this->defaultTitle = 'UniSheets'; /* can be a longer name, for titles */
		...
		$this->defaultProductName = 'UniSheets';
